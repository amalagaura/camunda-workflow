...
# definition is the same as the relation between Class and Class instance in OOP. When a process definition is started, a process instance
# is created.
...
class Camunda::ProcessInstance < Camunda::Model
  ...
  # @param hash [Hash] Transforms a hash of Camunda serialized variables to a simple Ruby hash and
  # snake_cases variable names
